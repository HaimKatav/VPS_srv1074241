---
pageType: source
id: source.runbook-add-a-persona
title: "Runbook: Add a Persona"
sourceType: local-file
sourcePath: /opt/traderb-wiki/concepts/process/runbooks/persona-add.md
ingestedAt: 2026-04-15T13:03:02.528Z
updatedAt: 2026-04-15T13:03:02.528Z
status: active
---

# Runbook: Add a Persona

## Source
- Type: `local-file`
- Path: `/opt/traderb-wiki/concepts/process/runbooks/persona-add.md`
- Bytes: 9110
- Updated: 2026-04-15T13:03:02.528Z
...
> Step-by-step executable checklist. Paired with `concepts/process/persona-lifecycle.md` (the policy). This is the "how." Policy is the "why."
...
### 8. Update `_shared/coordination-rules.md` enforcer matrix
...
### 9. Update `entities/team/index.md` roster
